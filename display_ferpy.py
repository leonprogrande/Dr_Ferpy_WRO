...
if __name__ == "__main__":
    print("Starting Ferpy Display Test...")
    start_display()
    
    # Test different states
    time.sleep(4)  # Wait for boot sequence
    print("Testing line state...")
    set_display_state('line')
    time.sleep(2)
    
    print("Testing stationary state...")
    set_display_state('stationary')
    time.sleep(2)
    
    print("Testing loading state...")
    set_display_state('loading')
    time.sleep(3)
